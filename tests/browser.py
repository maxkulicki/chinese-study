...
try:
 ...
 command('Emulation.setDeviceMetricsOverride',{'width':375,'height':568,'deviceScaleFactor':1,'mobile':True})
 check("getComputedStyle(document.querySelector('.session-actions')).position==='fixed' && document.querySelector('.session-actions').getBoundingClientRect().bottom<=innerHeight && getComputedStyle(document.querySelector('nav')).display==='none' && getComputedStyle(document.querySelector('header')).display==='none' && document.querySelector('main').scrollHeight<=document.querySelector('main').clientHeight",'session action stays visible in a 375x568 viewport')
 command('Emulation.setDeviceMetricsOverride',{'width':390,'height':844,'deviceScaleFactor':1,'mobile':True})
 ...
 command('Emulation.setDeviceMetricsOverride',{'width':320,'height':568,'deviceScaleFactor':1,'mobile':True})
 check("document.documentElement.scrollWidth<=innerWidth && document.querySelector('main').scrollHeight<=document.querySelector('main').clientHeight",'matching exercise fits 320x568 without scrolling')
 command('Emulation.setDeviceMetricsOverride',{'width':390,'height':844,'deviceScaleFactor':1,'mobile':True})
